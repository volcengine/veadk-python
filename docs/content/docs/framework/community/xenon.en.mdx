...
<Callout type="info">
  The integration commands below require the published Xenon `v0.8.2` release
  or later.
</Callout>
...
See the [Xenon integration CLI](https://github.com/xianyu-sheng/Xenon/blob/v0.8.2/docs/INTEGRATIONS.md)
