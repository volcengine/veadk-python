---
title: "持续优化"
description: "通过 Prompt 调优、强化学习与 Agent 自我反思，持续优化你的 VeADK 智能体。"
---
...
│   ├── random_reward.py              # reward 规则设定
│   ├── raw_async_veadk_rollout.py    # rollout 工作流设定
│   └── weather_rollout.py            # 天气查询 agent 的 rollout 示例
├── job.py                            # 任务提交代码
├── job.yaml                          # 任务配置
...
├── demo_calculate_agent.py      # agent 的 rollout 逻辑与 reward 设定
