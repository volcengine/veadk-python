...
- **能力栈**：工具（MCP / 本地 / 外部）、上下文存储（短期与长期[记忆](/cn/docs/framework/memory/short-term)及过期策略）、向量检索与文档解析、[可观测](/cn/docs/framework/observability)与[评测](/cn/docs/framework/evaluation)。
...
| 可观测与评测 | [可观测](/cn/docs/framework/observability)（日志、链路追踪、指标）与[评测](/cn/docs/framework/evaluation)闭环 |
