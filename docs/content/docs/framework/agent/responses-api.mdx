...
description: "使用火山方舟 Responses API 实现高效上下文管理、多模态理解与上下文缓存。"
---
...
<Cards>
  <Card title="构建智能体" href="/cn/docs/framework/agent/create" description="配置模型、工具与额外参数。" />
  <Card title="短期记忆" href="/cn/docs/framework/memory/short-term" description="管理多轮对话的会话上下文。" />
</Cards>
