---
title: "Prompt 管理"
description: "通过 CozeLoop 或自定义 Prompt Manager 对 Agent 系统提示词进行版本管理与热更新。"
---
...
<Cards>
  <Card title="构建智能体" href="/cn/docs/framework/agent/create" description="配置模型、工具与元信息。" />
  <Card title="链路追踪" href="/cn/docs/framework/observability/overview" description="观测每一次提示词加载与模型调用。" />
</Cards>
