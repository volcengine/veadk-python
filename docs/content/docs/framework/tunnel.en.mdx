...
async def main():
    connector = TunnelConnector(
        ...
        servers=[
            LocalServer(
                name="ops",
                address="http://your-mcp-host:9000/mcp",  # internal MCP server URL
...
See [`examples/14_mcp-tunnel`](https://github.com/volcengine/veadk-python/tree/main/examples/14_mcp-tunnel)
