---
title: "内置 MCP 工具"
description: "VeADK 基于 MCP（Model Context Protocol）接入的内置工具：MCP Router、飞书 / Lark、LAS 数据湖、视频云 VOD、Supabase 与可信 MCP 工具集。"
---
...
<Cards>
  <Card title="内置工具" href="/cn/docs/framework/tools/builtin" description="网页搜索、图像 / 视频生成、代码沙箱等原生函数工具。" />
  <Card title="飞书 Channel 扩展" href="/cn/docs/framework/tools/feishu-channel" description="把飞书机器人的入站消息接入 Runner。" />
  <Card title="自定义工具" href="/cn/docs/framework/tools/custom-function" description="把你自己的函数封装成工具。" />
</Cards>
