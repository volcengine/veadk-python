---
title: "Custom tools"
description: "Wrap your own Python functions as tools in VeADK: plain-argument functions, context-aware functions, and long-running tasks."
---
...
Add a `tool_context: ToolContext` parameter to a tool function to access the agent's runtime context — session ID, user identity, the current agent, and more. The framework injects this argument automatically; the model neither sees nor needs to pass it.
...
<Cards>
  <Card title="Built-in tools" href="/en/docs/framework/tools/builtin" description="Web search, image / video generation, code sandboxes, and more." />
  <Card title="Built-in MCP tools" href="/en/docs/framework/tools/builtin-mcp" description="Feishu / Lark, LAS, VOD, MCP Router, and more." />
</Cards>
