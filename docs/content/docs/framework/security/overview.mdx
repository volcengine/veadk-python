...
description: "Agent Identity 提供一站式身份及权限管理，保障 Agent 出站与入站操作的安全合规。"
---
...
- [使用 API Key 进行出站认证](/cn/docs/framework/security/outbound/api-key)
- [使用 OAuth2 M2M 进行出站认证](/cn/docs/framework/security/outbound/oauth2-m2m)
- [使用 OAuth2 USER_FEDERATION 进行出站认证](/cn/docs/framework/security/outbound/oauth2-user-federation)
