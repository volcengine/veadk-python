...
import type { ChatUIMessage, SearchTool } from '../../lib/chat-types';
...
export function AISearch({ children }: { children: ReactNode }) {
  ...
  const chat = useChat<ChatUIMessage>({
    ...
    transport: new DefaultChatTransport({
      // In static export (GitHub Pages) point at an external endpoint
      // (e.g. a VeFaaS function) via NEXT_PUBLIC_AI_CHAT_URL; locally falls
      // back to the in-app dev route.
      api: process.env.NEXT_PUBLIC_AI_CHAT_URL || '/api/chat',
    }),
  });
