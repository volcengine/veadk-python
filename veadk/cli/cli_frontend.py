...
def frontend_deploy(
    ...
    veadk_environments["SANDBOX_CHAT_OPENCLAW"] = sandbox_agent_tool_ids["openclaw"]
    veadk_environments["SANDBOX_CHAT_HERMES"] = sandbox_agent_tool_ids["hermes"]
