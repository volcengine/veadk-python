...
def test_multiple_clones():
    ...
    original = LlmAgent(name="original_agent", description="Agent for multiple cloning")
...
def test_clone_parent_agent_field():
    ...
    with pytest.raises(ValueError, match="Cannot update `parent_agent` field in clone"):
