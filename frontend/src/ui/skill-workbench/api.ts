...
async function errorFrom(response: Response, fallback: string): Promise<Error> {
  ...
  try {
    ...
    return new SkillWorkbenchApiError(
      ...
      response.statusText,
      detail.originalError && typeof detail.originalError === "object"
        ? detail.originalError as SkillWorkbenchApiError["originalError"]
        : undefined,
      text,
    );
  } catch {
...
function normalizeTask(value: unknown): SkillWorkbenchTask {
  ...
  return {
    ...
    ...(typeof task.style === "string" ? { style: task.style } : {}),
    ...(typeof task.requestedName === "string"
...
export async function getSkillWorkbenchCapability(
  ...
  return {
    ...
    models: Array.isArray(body.models)
      ...
      : [],
    styles: body.styles && typeof body.styles === "object" && !Array.isArray(body.styles)
      ? Object.fromEntries(
          Object.entries(body.styles).filter(
