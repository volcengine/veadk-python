...
"""Shared durable source-project boundary for build and migration producers."""
...
SourceProjectService = IntelligentDevelopmentProjectService
...
__all__ = ["SOURCE_PROJECT_EXCEPTIONS", "SourceProjectService"]
